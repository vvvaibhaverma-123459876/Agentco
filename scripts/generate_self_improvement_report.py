...
REPORT_PATH = ROOT / "docs" / "audit" / "SELF_IMPROVEMENT_EXPERIMENT_REPORT.json"
...
def main() -> int:
    ...
    failures = validate_experiment_report(report)
    ...
    if args.check:
        ...
        if REPORT_PATH.exists() and REPORT_PATH.read_text() != expected:
            ...
            return 1
        print("self-improvement experiment report ok")
        return 0
