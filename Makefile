...
governed-capability-genesis:
	@command -v $(PYTHON) >/dev/null || (echo "Python 3.13 is required. Install the configured interpreter or run with PYTHON=/path/to/interpreter"; exit 1)
	@$(PYTHON) scripts/run_governed_capability_genesis.py --campaign governed-capability-protocol-baseline-v1 --mode protocol-baseline-v1
...
real-capability-genesis-v2:
	@command -v $(PYTHON) >/dev/null || (echo "Python 3.13 is required. Install the configured interpreter or run with PYTHON=/path/to/interpreter"; exit 1)
	@$(PYTHON) scripts/run_governed_capability_genesis.py --campaign governed-capability-genesis-v3 --mode real-capability-genesis-v3
