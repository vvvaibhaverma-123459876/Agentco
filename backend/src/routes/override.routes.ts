...
export async function overrideRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/api/overrides', { preHandler: requireScope('governance:mutate') }, async (req, reply) => {
  ...
  fastify.get('/api/overrides/overdue', { preHandler: requireScope('governance:mutate') }, async (_req, reply) => {
