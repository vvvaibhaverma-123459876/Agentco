...
def test_run_best_effort_offline_fixture_exits_successfully():
    proc = subprocess.run([sys.executable, "-m", "runtime.orchestration.run_best_effort", "--mode", "offline_fixture"], cwd=ROOT, text=True, capture_output=True, timeout=30, check=False)
