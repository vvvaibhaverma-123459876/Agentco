...
RUNTIME_MODES: dict[str, RuntimeMode] = {
    "production": RuntimeMode(
        "production",
        ("python", "node", "npm", "backend_build", "frontend_build", "postgres", "migrations", "core_db_schema", "vault", "resolution_service", "sensitive_route_auth", "filesystem_reports"),
        ("kafka", "redis", "prometheus", "grafana", "openai_connectivity"),
        {},
        ("fake_llm", "file_ledger", "in_memory_db", "auth_bypass", "env_secrets"),
        True,
        True,
        False,
        True,
